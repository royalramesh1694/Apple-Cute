...
@app.on_message(filters.command(["honeytag", "honey" ], prefixes=["/", "@", "#"]))
...
@app.on_message(filters.command(["honeytag"], prefixes=["/", "@", "#"]))
...
@app.on_message(filters.command(["cancel", "stop" , "stoptag" , "tagstop"]))
